...
- [Implementation plan: the hint and info system](attention-and-detail-plan.md) - the nine sequenced steps, each independently shippable, with the observation that proves each one landed.
